    ...
    <>
      <div className="w-full h-screen bg-cover bg-center relative">
        ...
        <video
          ...
          preload="metadata"
          poster="hero-bg-2-thumb.png"
        >
          <source src="/videos/hero-bg-2.mp4#t=0.1" type="video/mp4" />
        ...
        <div className="absolute inset-0 flex justify-center items-center">
          <div className="w-3/4 max-w-lg h-auto backdrop-blur-2xl rounded-2xl p-8 flex flex-col justify-center items-center gap-4 text-center shadow-lg">
            <h1 className="font-ds text-4xl md:text-6xl lg:text-7xl bg-clip-text text-transparent bg-gradient-to-r from-purple-300 to-fuchsia-300">
              Sacred Vows
            </h1>
